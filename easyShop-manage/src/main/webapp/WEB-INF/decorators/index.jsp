...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
    <div id="wrapper">
        <%@include file="../jsp/system/common/menu.jspf" %>
        <!--右侧部分开始-->
            ...
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        <%@include file="../jsp/system/common/headerMessage.jspf" %>
                        <%@include file="../jsp/system/common/headerMessageWarn.jspf" %>
        ...
        <!--右侧部分结束-->
        <%@include file="../jsp/system/common/themConfig.jspf" %>
        <%@include file="../jsp/system/common/smallchat.jspf" %>
    </div>
